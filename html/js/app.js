(function() {
    ...
    let MenuTpl =
        ...
        '<div class="head"><img class="headimageleft" src="https://i.imgur.com/xCsf0pn.png"></img><img class="headimageright" src="https://i.imgur.com/nHsH06e.png"></img><div class="headtitle">{{{title}}}</div></div>' +
        '<div class="menu-description">{{{description}}}</div>' +
        '<div class="menu-html">{{{html}}}</div>' +
        '<div class="menu-items">' +
        '{{#elements}}' +
        '<div class="menu-item {{#selected}}selected{{/selected}}">' +
        '{{#showImage}}<img class="ItemImage" onerror="this.style.display=\'none\'" src="https://images.forasterosrp.com/items/{{{value}}}.png"/>{{/showImage}}{{{label}}}{{#isSlider}} : &lt;{{{sliderLabel}}}&gt;{{/isSlider}}' +
        '</div>' +
        '{{/elements}}' +
        '</div>' +
